...
### MONTH 7: AI Agents + Context + MCP + MLOps

#### Week 25-26 — AI Agents
**Kya padhna hai:**
- `09_AI_Agents/` (saari files, including `07_Agent_Frameworks_and_SDKs.md`)

**The future of AI:**
Agentic AI 2024-2025 ka biggest trend hai. Samjho ki agents kyun powerful hain, aur kyun woh fail karte hain. Dono equally important hain. Manual loop pehle; phir OpenAI / Claude / Vertex / Google ADK kab choose karna hai.

---

#### Week 27 — Context Engineering
**Kya padhna hai:**
- `14_Context_Engineering/` (saari files)

**Why this week exists:**
Prompt likhna alag skill hai; window mein kya jaata hai alag. Context layer, compaction, isolation, security, aur context evals — production AI ka real bottleneck yahan hai.

---

#### Week 28 — Model Context Protocol (MCP)
**Kya padhna hai:**
- `15_MCP/` (saari files)

**Goal:**
Host / Client / Server / Data / Transport samjho. Local vs remote connect. Production permissions. Multi-agent file mein jo short MCP blurb hai, uska deep dive yahan hai.

---

#### Week 29-30 — MLOps aur Production
**Kya padhna hai:**
- `10_MLOps_and_Production/` (saari files, especially `07_LLM_Observability.md` + `08_LLM_Evaluations.md`)

**Real world:**
Theory jaanna kafi nahi — tum ko pata hona chahiye ki production mein AI kaise chal ta hai. Ab LLM traces (LangSmith/Langfuse/Helicone/Arize) aur evals (RAGAS/DeepEval) bhi is phase ka hissa hain.
...
#### Week 31-33 — AI Ethics aur Safety (MOST IMPORTANT MODULE)
**Kya padhna hai:**
...
- RAG + Agents + Context Engineering + MCP dobara padhо
- MLOps observability/evals deep dive
...
#### Week 39-42 — Systematic Interview Prep
**Kya karna hai:**
...
**Week 39:** Conceptual Questions (100+)
**Week 40:** System Design
**Week 41:** Scenario-Based + Company-Specific
**Week 42:** Self-Introduction + Polish

---

### MONTH 12: The Real World

#### Week 43-46 — Execution
**Kya karna hai:**
...
| Month 6 | Design a RAG system conceptually + strong prompting |
| Month 7 | Describe agents + context layer + MCP + MLOps/observability |
