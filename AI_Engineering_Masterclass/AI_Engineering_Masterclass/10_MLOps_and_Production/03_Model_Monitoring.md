...
**Deep dive (LLM-native):** Tracing, Langfuse, Helicone, cost/latency playbooks → [`07_LLM_Observability.md`](07_LLM_Observability.md). Eval types and RAGAS/DeepEval → [`08_LLM_Evaluations.md`](08_LLM_Evaluations.md).
